...
const PrimaryBtn = ({ text, icon }) => {
  return (
    <button className="relative inline-flex items-center justify-center px-8 py-2.5 overflow-hidden tracking-tighter text-white bg-linear-to-r from-orange-500 to-red-500 rounded-md group">
